...
export default function spawnYield(container, scene, x, y) {
   ...
   const linePos = new Vector3(x, -0.01, y + 4.2)
   ...
   line.forEach((box, i = 0) => {
      box.position = new Vector3(linePos.x,linePos.y,linePos.z - i*1.3)
