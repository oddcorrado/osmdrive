...
export default function createButtons (scene){
    ...
    var wheel = buttonDriveCreator('z-index: 0;bottom: 1rem; left: 1rem; height:12rem; width: 12rem;', {style: 'height: 12rem; width: 12rem; ', id: 'wheel', img: '../images/steerwheel2.svg'})
