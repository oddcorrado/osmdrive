...
export default function createButtons (scene){
    ...
    var touchZone = divCreator('opacity: 0.7; background:  no-repeat center/100% url(\'../images/arrows.svg\');z-index: 5; bottom: 40vh; left: 2vw; height: 16vh; width: 19vw; display: block;', {id: 'touchzone', text:''});
