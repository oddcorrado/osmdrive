...
export function feedbackDivCreator(content){
    let div = 
    `<div id='new-score${id}' style='position: absolute; top: 2%; left: 5%; width: 23vw; height: 8.5vh; background-color: white; box-shadow: -1px 2px 7.2px 1.8px rgba(0, 0, 0, 0.15); border-radius: 10vh; font-family: "Asap Condensed", sans serif; font-size: 2.5vh'>
...
// export function feedbackDivCreatorold(content){
//     let div = 
